...
// import { FaUserCircle, FaFilePdf, FaTimes } from 'react-icons/fa';
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (file) {
        ...
        response = await axios.post('http://localhost:8000/process_pdf', formData, {
          headers: { 'Content-Type': 'multipart/form-data' },
        });
      } else {
        response = await axios.post('http://localhost:8000/generate', { prompt });
      }
    ...
    <div className="min-h-full bg-gradient-to-b from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-900 flex w-full flex-col items-center p-4">
      <div className="w-full h-[75%] ">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg h-full  shadow-lg p-6">
          {/* Chat History */}
          <div className="max-h-[100%] overflow-y-auto mb-6 p-4 bg-gray-50 dark:bg-gray-700 rounded-md">
            {history.length === 0 && (
              ...
              <div key={index} className="mb-4">
                ...
                <div className="flex justify-end">
                  <div className="flex items-start gap-2 max-w-md">
                    ...
                    {/* <FaUserCircle className="text-2xl text-blue-500 dark:text-blue-300 mt-2" /> */}
                  </div>
                </div>
                {/* Bot Response */}
                <div className="flex justify-start mt-2">
                  <div className="flex items-start gap-2 max-w-md">
                    {/* <FaUserCircle className="text-2xl text-gray-500 dark:text-gray-300 mt-2" /> */}
                ...
                <div className="relative w-full">
                  ...
                  {file && (
                    <div className="absolute top-2 right-2 flex items-center gap-2 text-gray-600 dark:text-gray-300">
                      ...
                      {/* <span className="text-sm truncate max-w-[50px]">{file.name}</span> */}
                      <button
                        type="button"
